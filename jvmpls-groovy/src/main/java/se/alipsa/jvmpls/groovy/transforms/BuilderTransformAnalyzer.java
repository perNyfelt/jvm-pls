...
final class BuilderTransformAnalyzer implements TransformAnalyzer {
  ...
  public List<SyntheticMemberSpec> analyze(ClassNode classNode, AnnotationNode annotation, TransformContext context) {
    ...
    specs.add(SyntheticMemberSpec.syntheticClass(builderFqn, context.locationOf().apply(annotation), origin, confidence));
    specs.add(SyntheticMemberSpec.syntheticMethod(
        context.ownerFqn(),
        "builder",
        new MethodSignature(List.of(), new ClassType(builderFqn, List.of()), List.of(), List.of(), List.of(), Set.of("public", "static")),
    ...
    for (PropertyNode property : classNode.getProperties()) {
      ...
      specs.add(SyntheticMemberSpec.syntheticMethod(
          builderFqn,
          property.getName(),
          new MethodSignature(List.of(propertyType), new ClassType(builderFqn, List.of()),
              List.of(property.getName()), List.of(), List.of(), Set.of("public")),
    ...
    specs.add(SyntheticMemberSpec.syntheticMethod(
        builderFqn,
        "build",
        new MethodSignature(List.of(), new ClassType(context.ownerFqn(), List.of()), List.of(), List.of(), List.of(), Set.of("public")),
        context.locationOf().apply(annotation),
        Set.of("public"),
        origin,
        confidence));
