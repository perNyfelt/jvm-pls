...
public final class PluginRegistry {
  ...
  public void register(JvmLangPlugin plugin) {
    ...
    if (byId.putIfAbsent(plugin.id(), plugin) != null) {
      env.log(
          "WARN",
          "Plugin with id=" + plugin.id() + " already registered; ignoring duplicate.",
          null);
      return;
    }
  ...
  public Optional<JvmLangPlugin> byId(String id) {
